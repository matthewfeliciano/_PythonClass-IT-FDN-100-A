...
animal = ''
objFile = None
# Store Animal and their sound in a
listanimal = str(input("Enter a your favorite animal: "))
...
MethodobjFile = open("AnimalSounds.dat", "wb")
pickle.dump(animal_lst, objFile)
objFile.close()

# Read Data with Pickle
MethodobjFile = open("AnimalSounds.dat", "rb")
